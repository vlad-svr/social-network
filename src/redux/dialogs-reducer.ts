...
const initialState = {
  messages: [
    ...
    { id: 11, message: 'Привет, хорошо', myMessage: false },
    { id: 12, message: 'Привет, как дела?', myMessage: true },
    { id: 13, message: 'Чем занимаешься?', myMessage: false },
    { id: 14, message: 'Ура!', myMessage: true },
    { id: 15, message: 'Хорошо!', myMessage: false },
    { id: 16, message: 'Привет, хорошо', myMessage: false },
    { id: 17, message: 'Привет, как дела?', myMessage: true },
    { id: 18, message: 'Чем занимаешься?', myMessage: false },
    { id: 19, message: 'Ура!', myMessage: true },
    { id: 20, message: 'Хорошо!', myMessage: false },
